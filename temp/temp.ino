...
// WiFi
const char* ssid = "PSK-JioFiber_4G";                 // Your personal network SSID
const char* wifi_password = "19752001"; // Your personal network password

// MQTT
const char* mqtt_server = "192.168.29.206";  // IP of the MQTT broker
